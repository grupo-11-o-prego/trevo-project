...
class UserModel extends Model {
    ...
    public function cadastrar($nome, $email, $data_nasc, $contato, $senha) {
        try{
            ...
            if (!$emailExiste) {
                $stmt = $this->conn->prepare('INSERT INTO usuarios_tb (user_ativo, user_nome, user_email, user_data_nasc, user_contato, user_senha, user_moderador, user_data, user_vendedor) VALUES (1, :nome, :email, :data_nasc, :contato, :senha, 0, :dia, 0)');
