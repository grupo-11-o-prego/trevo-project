function handleSubmitForTitulo() {
    const form = document.getElementById("alterartitulo-form");
    
    const formData = new FormData(form);
    
    var ok = "";
    // Faz a requisição POST com os dados capturados do formulário
    requisitar('POST', '/trevo-project/public/api/forum/alterartitulo', formData, 'formdata')
        .then(result => {
            console.log(result)
            if (result.erro) {
